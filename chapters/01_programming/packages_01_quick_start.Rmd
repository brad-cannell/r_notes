...
2. Update documentation/vignettes using `devtools::document()`
...
7. If you don't plan to submit to CRAN, this is probably a good time to use `devtools::install()` to re-build and install the package locally.

8. Update `cran-comments`.   
 - If this is a resubmission, add a bulleted list of changes made under ## Resubmission.

9. Submit with `devtools::release()`
